...
* $\sigma (F) = \\{ \\{a \mid \testbf{in}(a) \in I \\} \mid I \in \mathcal{AS}( \pi_F \cup \pi_{\sigma} )$
* $\hat \sigma (m(F)) = \\{ \\{a \mid \testbf{abs\\_in}(\hat a) \in I \\} \mid I \in \mathcal{AS}( \pi_F \cup \pi_m \cup \pi_{m(F)} \cup \pi_{\hat \sigma} )$
